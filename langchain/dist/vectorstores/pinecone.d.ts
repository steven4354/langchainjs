...
export declare class PineconeStore extends VectorStore {
    ...
    static fromTexts(pineconeClient: VectorOperationsApi, texts: string[], metadatas: object[], embeddings: Embeddings, textKey?: string, namespace?: string | undefined): Promise<PineconeStore>;
